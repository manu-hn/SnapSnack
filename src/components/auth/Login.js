    ...
    return (
        <>
            ...
            <div className="w-full text-center">
                <p className="text-xs font-extralight text-gray-400">To access the username and password details for login,
                     I've utilized the <b> dummyjson </b> authentication method. You can find the information by visiting{' '}
                      <Link target="_blank" to={'https://dummyjson.com/users'} className="text-blue-500 underline">Click Here</Link> </p>
            </div>
        </>
    )
}
