...
export const MAIN_URL = `https://www.swiggy.com/dapi/restaurants/list/v5?lat=12.9000069&lng=77.5777031&is-seo-homepage-enabled=true&page_type=DESKTOP_WEB_LISTING`;
