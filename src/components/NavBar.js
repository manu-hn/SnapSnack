...
import useLocationSearch from "./utils/useLocationSearch.js";
...
const NavBar = () => {
    ...
    const { fetchLatAndLong } = useLocationSearch()
    ...
    return (
        <div className="flex w-full px-2 py-2 bg-orange-500 justify-between items-center flex-col">
            ...
            <div className="flex w-full justify-evenly items-center px-8">
                ...
                />
                <button className="px-6 py-1 rounded-lg border ml-4" onClick={() => fetchLatAndLong(location)}>
                    Search
                </button>
            </div>
